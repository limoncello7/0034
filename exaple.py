...
BRENT_DAILY_FILEPATH = Path(__file__).parent.joinpath('0034', 'brent-daily.csv')
GAS_DAILY_FILEPATH = Path(__file__).parent.joinpath('0034', 'gas-daily.csv')
BRENT_MONTH_FILEPATH = Path(__file__).parent.joinpath('0034', 'brent-month.csv')
GAS_MONTHLY_FILEPATH = Path(__file__).parent.joinpath('0034', 'gas-monthly.csv')
WTI_DAILY_FILEPATH = Path(__file__).parent.joinpath('0034', 'wti-daily.csv')
WTI_MONTHLY_FILEPATH = Path(__file__).parent.joinpath('0034', 'wti-month.csv')
...
df_events = pd.read_csv(BRENT_DAILY_FILEPATH, usecols=cols)
...
df_map_events = pd.read_csv(BRENT_DAILY_FILEPATH, usecols=map_cols)
